    ...
    <div className={[styles.listingDescription, className].join(" ")}>
      ...
      <div className={styles.descriptionContent}>
        ...
        <div className={styles.highlights}>
          <DetailsCard
            highlightIcons="/frame-65.svg"
            dedicatedWorkspace="Dedicated workspace"
            aPrivateRoomEquippedWithWi="A private room equipped with WiFi"
          />
          <DetailsCard
            highlightIcons="/frame-65-1.svg"
            dedicatedWorkspace="Self check-in"
            aPrivateRoomEquippedWithWi="Check in with just your phone"
          />
          <DetailsCard
            highlightIcons="/frame-65-2.svg"
            dedicatedWorkspace="Free cancellation"
            aPrivateRoomEquippedWithWi="Cancel anytime"
          />
        </div>
      </div>
    </div>
