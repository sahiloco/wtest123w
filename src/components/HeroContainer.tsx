...
const HeroContainer: FunctionComponent<HeroContainerType> = ({
  ...
  const [dateGuestItemsValue, setDateGuestItemsValue] = useState(null);
  const [dateGuestItems1Value, setDateGuestItems1Value] = useState(null);
  return (
          ...
          <div className={styles.frameParent}>
            ...
            <div className={styles.form}>
              ...
              <div className={styles.grouped}>
                <div className={styles.dateGuestItems}>
                  <DatePicker
                    value={dateGuestItemsValue}
                    onChange={(newValue: any) => {
                      setDateGuestItemsValue(newValue);
                    }}
                    sx={{
                      fieldset: {
                        borderColor: "#d9d9d9",
                ...
                <div className={styles.dateGuestItems}>
                  <DatePicker
                    value={dateGuestItems1Value}
                    onChange={(newValue: any) => {
                      setDateGuestItems1Value(newValue);
                    }}
                    sx={{
                      fieldset: {
                        borderColor: "#d9d9d9",
